...
def show_update_detail():
    ...
    if request.method=='POST':
        ...
        qry_pat = "select Patient_ID, organ_req, Lab_reports, Doctor_name from Patient inner join Doctor on Doctor.Doctor_ID = Patient.Doctor_ID and User_ID = %s" %(request.form['User_ID'])
